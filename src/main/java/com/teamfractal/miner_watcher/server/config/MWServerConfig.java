...
public class MWServerConfig {
    ...
    public static ForgeConfigSpec.BooleanValue CHAT_NOTIFY_CHECK_SURVIVAL;
    ...
    public static ForgeConfigSpec.BooleanValue LOG_NOTIFY_1_CHECK_SURVIVAL;
    ...
    public static ForgeConfigSpec.BooleanValue LOG_NOTIFY_2_CHECK_SURVIVAL;
    ...
    public static ForgeConfigSpec.BooleanValue LOG_NOTIFY_3_CHECK_SURVIVAL;
    ...
    static{
        ...
        CHAT_NOTIFY_CHECK_SURVIVAL = SERVER_BUILDER.comment("","Should we check if the miner is in survival mode before notifying in chat?")
                .define("chat_notify_check_survival",true);
        ...
        LOG_NOTIFY_1_CHECK_SURVIVAL = SERVER_BUILDER.comment("","Should we check if the miner is in survival mode before notifying in log event 1?")
                .define("log_notify_1_check_survival",true);
        ...
        LOG_NOTIFY_2_CHECK_SURVIVAL = SERVER_BUILDER.comment("","Should we check if the miner is in survival mode before notifying in log event 2?")
                .define("log_notify_2_check_survival",true);
        ...
        LOG_NOTIFY_3_CHECK_SURVIVAL = SERVER_BUILDER.comment("","Should we check if the miner is in survival mode before notifying in log event 3?")
                .define("log_notify_3_check_survival",true);
